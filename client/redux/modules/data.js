...
export function loadData(clientId, validationKey, email) {
  return dispatch => {
    return fetch(`https://happy.app.com/balboa3/clientscreen/index/${clientId}?validation_key=${validationKey}&email=${email}`)
      .then(
        res => {
...
export function saveData(clientId, validationKey, email, event) {
  ...
  return dispatch => {
    return fetch(`https://happy.app.com/balboa3/clientscreen/update/`, {
      method: 'POST',
      body: formdata,
    });
  }
...
export function saveOthernote(clientId, validationKey, email, note) {
  ...
  return dispatch => {
    return fetch(`https://happy.app.com/balboa3/clientscreen/othernote/`, {
      method: 'POST',
      body: formdata,
    });
  }
